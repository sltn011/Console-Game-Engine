...
namespace CGE {
    ...
    public:
        ...
        , float ny
            ...
            int x = static_cast<int>(std::roundf(sx * m_width));
            int y = static_cast<int>(std::roundf(sy * m_height));
            return getPixel(x, y);
        }
    ...
    public:
        ...
        , short fontHeight
            ...
            SetConsoleCtrlHandler(reinterpret_cast<PHANDLER_ROUTINE>(CloseHandle), TRUE);
